            ...
            <form method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="smtp_host" value="<?php echo $current_settings ? htmlspecialchars($current_settings['smtp_host']) : 'smtp.gmail.com'; ?>" required>
                        <p class="help-text">Usually: smtp.gmail.com for Gmail</p>
                    </div>
                    
                    <div class="form-group">
                        <label><i class="fas fa-network-wired"></i> SMTP Port</label>
                        <input type="number" name="smtp_port" value="<?php echo $current_settings ? $current_settings['smtp_port'] : '587'; ?>" required>
                        <p class="help-text">587 for TLS or 465 for SSL</p>
                    </div>
                </div>
