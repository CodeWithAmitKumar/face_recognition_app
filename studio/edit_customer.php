...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE customers SET customer_name=?, address_at=?, address_po=?, district=?, state=?, pin_code=?, whatsapp_no=?, contact_no=? WHERE customer_id=? AND studio_id=?");
    $stmt->bind_param("ssssssssii", $customer_name, $address_at, $address_po, $district, $state, $pin_code, $whatsapp_no, $contact_no, $customer_id, $studio_id);
...
<body>
    ...
    <div class="container">
        <a href="manage_customers.php" class="btn-back">
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address_at" value="<?php echo htmlspecialchars($customer['address_at']); ?>" required>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label><i class="fas fa-mail-bulk"></i> Post Office (PO)</label>
                        <input type="text" name="address_po" value="<?php echo htmlspecialchars($customer['address_po']); ?>">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pin_code" value="<?php echo htmlspecialchars($customer['pin_code']); ?>" pattern="[0-9]{6}" maxlength="6" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" name="whatsapp_no" value="<?php echo htmlspecialchars($customer['whatsapp_no']); ?>" pattern="[0-9]{10}" maxlength="10" required>
                    </div>
                    
                    <div class="form-group">
                        <label><i class="fas fa-phone"></i> Contact Number *</label>
                        <input type="tel" name="contact_no" value="<?php echo htmlspecialchars($customer['contact_no']); ?>" pattern="[0-9]{10}" maxlength="10" required>
                    </div>
                </div>
